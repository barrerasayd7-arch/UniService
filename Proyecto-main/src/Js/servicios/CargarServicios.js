        ...
        .then(data => {
                ...
                const tarjeta = `
                    ...
                    <div class="card-body-custom">
                        <span class="etiqueta et-azul">${servicio.nombre_categoria || "Categoría no especificada"}</span>
                        <p class="card-meta">${servicio.universidad===1 ? "Universidad Popular del Cesar" : "Universidad no especificada"}</p>
                        <h5>${servicio.titulo}</h5>
                        <p class="texto-muted">${servicio.descripcion}</p>
                        <div class="card-autor">
                        <div class="avatar avatar-azul">👤</div>
                        <span class="texto-muted">${servicio.proveedor || "Proveedor anónimo"}</span>
                        </div>
                        <div class="texto-fecha">${servicio.fecha_publicacion || ""}</div>
